...
map.getView().fit([189593.232292, 6094004.504378, 2095654.690800, 7190925.452064], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">Euro 2024 Stadiums</h2>';
        return titleElement;
    })(),
    ...
    element: (() => {
        ...
        if (115 > 240) {
            ...
            window.showAbstract = function() {
                ...
                linkElement.innerHTML = 'This map features all the stadiums in which the Euro 2024 tournoument was played at.<br />Email: dardan.idrizi@gmail.com';
            }
